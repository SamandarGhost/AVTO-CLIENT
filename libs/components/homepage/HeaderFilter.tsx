				...
				<Stack className={'search-box'}>
					<Stack className={'select-box'}>
						...
						<Box className={`box ${openType ? 'on' : ''}`} onClick={typeStateChangeHandler}>
							<span> {searchFilter?.search?.typeList ? searchFilter?.search?.typeList[0] : t('Made In')} </span>
							<ExpandMoreIcon />
						</Box>
						<Box className={`box ${openType ? 'on' : ''}`} onClick={typeStateChangeHandler}>
						...
						<Box className={`box ${openRooms ? 'on' : ''}`} onClick={roomStateChangeHandler}>
							<span>
								{searchFilter?.search?.roomsList ? `${searchFilter?.search?.roomsList[0]} rooms}` : t('Brand')}
							</span>
							<ExpandMoreIcon />
						</Box>
					</Stack>
									...
									<div className={'box'}>
										...
										<div className={'inside'}>
											<FormControl
												...
												>
													<MenuItem value={'all'}>All Made In</MenuItem>
													<MenuItem value={'propertyBarter'}>Korea</MenuItem>
													<MenuItem value={'propertyRent'}>USA</MenuItem>
													<MenuItem value={'propertyBarter'}>Germany</MenuItem>
													<MenuItem value={'propertyBarter'}>Japan</MenuItem>
													<MenuItem value={'propertyBarter'}>China</MenuItem>
													<MenuItem value={'propertyBarter'}>France</MenuItem>
													<MenuItem value={'propertyBarter'}>Italy</MenuItem>
													<MenuItem value={'propertyBarter'}>UK</MenuItem>
													<MenuItem value={'propertyBarter'}>Russia</MenuItem>
													<MenuItem value={'propertyBarter'}>India</MenuItem>
													<MenuItem value={'propertyBarter'}>Sweden</MenuItem>
													<MenuItem value={'propertyBarter'}>Czechia</MenuItem>
													<MenuItem value={'propertyBarter'}>Netherlands</MenuItem>
													<MenuItem value={'propertyBarter'}>Romania</MenuItem>
													<MenuItem value={'propertyBarter'}>Spain</MenuItem>
													<MenuItem value={'propertyBarter'}>Others</MenuItem>
												</Select>
											</FormControl>
										</div>
									</div>
										...
										<div className={'inside'}>
											<FormControl>
												...
												>
													...
													<MenuItem value={'propertyBarter'}>Luxury</MenuItem>
													<MenuItem value={'propertyRent'}>Super Car</MenuItem>
													<MenuItem value={'propertyBarter'}>Sport</MenuItem>
													<MenuItem value={'propertyBarter'}>Family</MenuItem>
													<MenuItem value={'propertyBarter'}>Economy</MenuItem>
													<MenuItem value={'propertyBarter'}>Land Car</MenuItem>
													<MenuItem value={'propertyBarter'}>City Car</MenuItem>
												</Select>
											</FormControl>
										</div>
									</div>
										...
										<div className={'inside'}>
											<FormControl>
												<Select
													...
													inputProps={{ 'aria-label': 'Without label' }}
												>
													<MenuItem value={'all'}>All Fuel Type</MenuItem>
													<MenuItem value={'propertyBarter'}>Gasoline</MenuItem>
													<MenuItem value={'propertyRent'}>Diesel</MenuItem>
													<MenuItem value={'propertyRent'}>Electric</MenuItem>
													<MenuItem value={'propertyRent'}>Hybrid</MenuItem>
													<MenuItem value={'propertyRent'}>CNG</MenuItem>
													<MenuItem value={'propertyRent'}>LPG</MenuItem>
												</Select>
											</FormControl>
										</div>
									</div>
										...
										<div className={'inside'}>
											<FormControl>
												...
												>
													...
													<MenuItem value={'propertyBarter'}>New Car</MenuItem>
													<MenuItem value={'propertyRent'}>Used Car</MenuItem>
												</Select>
											</FormControl>
										</div>
									</div>
